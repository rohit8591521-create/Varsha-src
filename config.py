...
BOT_TOKEN = getenv("BOT_TOKEN", "8984296437:AAHNDT6wLxGbldmtn3nOww_TAQyyDtpjf80")
OWNER_ID = list(map(int, getenv("OWNER_ID", "8600526963").split()))
...
LOG_GROUP = getenv("LOG_GROUP", "-1003903422245")
CHANNEL_ID = int(getenv("CHANNEL_ID", "-1003903422245"))
